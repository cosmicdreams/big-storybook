...
import '../../css/baseline/typography.css';
...
export const TextEffects = {
  ...
  args: {
    ...
    content: 'Modern typography brings editorial quality to the web. By using native Baseline features like initial-letter, we can achieve complex layouts without brittle hacks or extra spans. This paragraph demonstrates a drop cap starting the text flow.'
  }
};
