...
import '../../css/baseline/popover.css';
...
export const SideDrawer = {
  ...
  args: {
    ...
    title: 'User Profile',
    content: 'This drawer uses the Popover API combined with modern CSS properties like @starting-style and overlay to achieve a high-performance slide-out animation.',
    width: 400,
